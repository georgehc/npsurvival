...
from npsurvival_models import RandomSurvivalForestANN
...
survival_estimator_name = 'rsfann'  # for this file
    ...
    for dataset in datasets:
        ...
        for n_estimators, max_depth in hyperparams:
            ...
            for train_idx, val_idx in kf.split(X_train):
                ...
                surv_model = RandomSurvivalForestANN(n_estimators=n_estimators,
                                                     max_depth=max_depth,
                                                     min_samples_leaf=3,
                                                     random_state=rng,
                                                     n_jobs=-1)
        ...
        csv_writer.writerow([dataset, experiment_idx, 'adaptive kernel',
                             final_test_scores['cindex']] +
                            [final_test_scores[q]
                             for q in IPEC_percentiles])
